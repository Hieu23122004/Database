...
-- Dữ liệu được insert vào imageData : GPT
...
('Ao so mi', 'Thoi trang', 'M', 'Emerald Green', 100000, 30, 'Ao so mi nu', 
    (SELECT * FROM OPENROWSET(BULK N'C:\QuanLiBanQuanAo_Database-master\Picture\aosominu.jpg', SINGLE_BLOB) AS imageData)),
('Chan vay', 'Thoi trang', 'L', 'Rose Gold', 250000, 25, 'Chan vay nu', 
    (SELECT * FROM OPENROWSET(BULK N'C:\QuanLiBanQuanAo_Database-master\Picture\chanvay.jpg', SINGLE_BLOB) AS imageData)),
('Quna coc', 'Thoi trang', 'M', 'Mustard Yellow', 30000, 10, 'Quan cam nam', 
    (SELECT * FROM OPENROWSET(BULK N'C:\QuanLiBanQuanAo_Database-master\Picture\quancam.jpg', SINGLE_BLOB) AS imageData)),
('Quan soc', 'Thoi trang', 'L', 'Lavender', 35000, 20, 'Quan soc nam', 
    (SELECT * FROM OPENROWSET(BULK N'C:\QuanLiBanQuanAo_Database-master\Picture\quansoc.jpg', SINGLE_BLOB) AS imageData)),
('Vest', 'Thoi trang', 'M', 'Emerald Green', 150000, 40, 'Vest nam', 
    (SELECT * FROM OPENROWSET(BULK N'C:\QuanLiBanQuanAo_Database-master\Picture\vest.jpg', SINGLE_BLOB) AS imageData)),
('Ao len', 'Thoi trang', 'L', 'Rose Gold', 600000, 15, 'Ao len nam', 
    (SELECT * FROM OPENROWSET(BULK N'C:\QuanLiBanQuanAo_Database-master\Picture\aolen.jpg', SINGLE_BLOB) AS imageData)),
('Ao len', 'Thoi trang', 'S', 'Mint Green', 80000, 30, 'Ao len nu', 
    (SELECT * FROM OPENROWSET(BULK N'C:\QuanLiBanQuanAo_Database-master\Picture\aolennam.jpg', SINGLE_BLOB) AS imageData)),
('Vay', 'Thoi trang', 'M', 'Rose Gold', 350000, 15, 'Vay body', 
    (SELECT * FROM OPENROWSET(BULK N'C:\QuanLiBanQuanAo_Database-master\Picture\vaybody.jpg', SINGLE_BLOB) AS imageData)),
('Vay', 'Thoi trang', 'L', 'Burgundy', 85000, 50, 'Quan jean nu', 
    (SELECT * FROM OPENROWSET(BULK N'C:\QuanLiBanQuanAo_Database-master\Picture\vayxoe.jpeg', SINGLE_BLOB) AS imageData)),
('Quan', 'Thoi trang', 'M', 'Teal', 55000, 10, 'Quan dq2', 
    (SELECT * FROM OPENROWSET(BULK N'C:\QuanLiBanQuanAo_Database-master\Picture\quandq2.jpg', SINGLE_BLOB) AS imageData));
